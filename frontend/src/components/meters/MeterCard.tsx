    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
        <div style={{ minWidth: 0, flex: 1 }}>
          <h3 style={{ fontSize: 18, fontWeight: 900, textShadow: '0 1px 2px rgba(0,0,0,0.1)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {meter.nom}
          </h3>
          <span style={{ fontSize: 11, opacity: 0.85, fontWeight: 600 }}>N° : {meter.numero_compteur}</span>
        </div>
        <div style={{ background: 'rgba(255, 255, 255, 0.2)', padding: 8, borderRadius: 12, flexShrink: 0 }}>
          {isSenelec ? (
